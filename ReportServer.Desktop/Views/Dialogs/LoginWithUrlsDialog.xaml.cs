...
{
    public partial class LoginWithUrlsDialog : BaseMetroDialog
    {
        /// <summary>Identifies the <see cref="ServiceUrl"/> dependency property.</summary>
        public static readonly DependencyProperty ServiceUrlProperty = DependencyProperty.Register(nameof(ServiceUrl), typeof(string), typeof(LoginWithUrlsDialog), new PropertyMetadata(default(string)));

        public string ServiceUrl
        {
            get { return (string)this.GetValue(ServiceUrlProperty); }
            set { this.SetValue(ServiceUrlProperty, value); }
        }

        /// <summary>Identifies the <see cref="AuthUrl"/> dependency property.</summary>
        public static readonly DependencyProperty AuthUrlProperty = DependencyProperty.Register(nameof(AuthUrl), typeof(string), typeof(LoginWithUrlsDialog), new PropertyMetadata(default(string)));

        public string AuthUrl
        {
            get { return (string)this.GetValue(AuthUrlProperty); }
            set { this.SetValue(AuthUrlProperty, value); }
        }

        /// <summary>Identifies the <see cref="Message"/> dependency property.</summary>
        public static readonly DependencyProperty MessageProperty = DependencyProperty.Register(nameof(Message), typeof(string), typeof(LoginWithUrlsDialog), new PropertyMetadata(default(string)));
        ...
        public static readonly DependencyProperty UsernameProperty = DependencyProperty.Register(nameof(Username), typeof(string), typeof(LoginWithUrlsDialog), new PropertyMetadata(default(string)));
        ...
        public static readonly DependencyProperty UsernameWatermarkProperty = DependencyProperty.Register(nameof(UsernameWatermark), typeof(string), typeof(LoginWithUrlsDialog), new PropertyMetadata(default(string)));
        ...
        public static readonly DependencyProperty UsernameCharacterCasingProperty = DependencyProperty.Register(nameof(UsernameCharacterCasing), typeof(CharacterCasing), typeof(LoginWithUrlsDialog), new PropertyMetadata(default(CharacterCasing)));
        ...
        public static readonly DependencyProperty PasswordProperty = DependencyProperty.Register(nameof(Password), typeof(string), typeof(LoginWithUrlsDialog), new PropertyMetadata(default(string)));
        ...
        public static readonly DependencyProperty PasswordWatermarkProperty = DependencyProperty.Register(nameof(PasswordWatermark), typeof(string), typeof(LoginWithUrlsDialog), new PropertyMetadata(default(string)));
        ...
        public static readonly DependencyProperty AffirmativeButtonTextProperty = DependencyProperty.Register(nameof(AffirmativeButtonText), typeof(string), typeof(LoginWithUrlsDialog), new PropertyMetadata("OK"));
        ...
        public static readonly DependencyProperty NegativeButtonTextProperty = DependencyProperty.Register(nameof(NegativeButtonText), typeof(string), typeof(LoginWithUrlsDialog), new PropertyMetadata("Cancel"));
        ...
        public static readonly DependencyProperty NegativeButtonButtonVisibilityProperty = DependencyProperty.Register(nameof(NegativeButtonButtonVisibility), typeof(Visibility), typeof(LoginWithUrlsDialog), new PropertyMetadata(Visibility.Collapsed));
        ...
        public static readonly DependencyProperty ShouldHideUsernameProperty = DependencyProperty.Register(nameof(ShouldHideUsername), typeof(bool), typeof(LoginWithUrlsDialog), new PropertyMetadata(false));
        ...
        public static readonly DependencyProperty RememberCheckBoxVisibilityProperty = DependencyProperty.Register(nameof(RememberCheckBoxVisibility), typeof(Visibility), typeof(LoginWithUrlsDialog), new PropertyMetadata(Visibility.Collapsed));
        ...
        public static readonly DependencyProperty RememberCheckBoxTextProperty = DependencyProperty.Register(nameof(RememberCheckBoxText), typeof(string), typeof(LoginWithUrlsDialog), new PropertyMetadata("Remember"));
        ...
        public static readonly DependencyProperty RememberCheckBoxCheckedProperty = DependencyProperty.Register(nameof(RememberCheckBoxChecked), typeof(bool), typeof(LoginWithUrlsDialog), new PropertyMetadata(false));
        ...
        internal LoginWithUrlsDialog()
            : this(null)
        {
        }

        internal LoginWithUrlsDialog(MetroWindow parentWindow)
            : this(parentWindow, null)
        {
        }

        internal LoginWithUrlsDialog(MetroWindow parentWindow, LoginWithUrlsDialogSettings settings)
            : base(parentWindow, settings)
        {
            this.InitializeComponent();
            this.ServiceUrl = settings.InitialServiceUrl;
            this.AuthUrl = settings.InitialAuthUrl;
        ...
        internal Task<LoginWithUrlsDialogData> WaitForButtonPressAsync()
        {
            this.Dispatcher.BeginInvoke(new Action(() =>
                {
                    this.Focus();
                    if (string.IsNullOrEmpty(this.PART_ServiceUrlTextBox.Text))
                    {
                        this.PART_ServiceUrlTextBox.Focus();
                    }
                    else if (string.IsNullOrEmpty(this.PART_AuthUrlTextBox.Text))
                    {
                        this.PART_AuthUrlTextBox.Focus();
                    }
                    else if (string.IsNullOrEmpty(this.PART_TextBox.Text) && !this.ShouldHideUsername)
                    {
            ...
            TaskCompletionSource<LoginWithUrlsDialogData> tcs = new TaskCompletionSource<LoginWithUrlsDialogData>();
            ...
            affirmativeKeyHandler = (sender, e) =>
                {
                    ...
                    {
                        cleanUpHandlers();
                        tcs.TrySetResult(new LoginWithUrlsDialogData
                                         {
        ...
        {
            var settings = this.DialogSettings as LoginWithUrlsDialogSettings;
